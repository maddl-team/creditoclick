                ...
                <div className="lg:col-span-2">
                    <SectionIntro
                        ...
                        description={
                            <>
                                <p>
                                    Non siamo un comparatore automatico. Non siamo una banca. Siamo un’agenzia in attività finanziaria convenzionata, composta da consulenti specializzati che lavorano ogni giorno per trovare la soluzione di credito più adatta alla tua situazione reale — non a quella ideale.
                                </p>
                                <p>
                                    Operiamo come Agente Monomandatario di IBL Banca, siamo iscritti all’OAM (Organismo Agenti e Mediatori) e lavoriamo nel pieno rispetto della normativa sulla trasparenza bancaria e del Codice del Consumo.
                                </p>
                            </>
                        }
                    />
