        ...
        <Section className="relative overflow-hidden pt-32 pb-20 md:pt-48 md:pb-32 min-h-[90vh] flex items-center">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-0 items-center w-full">
                ...
                <div className="lg:col-span-2 pr-0 lg:pr-12">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-text-primary mb-8 leading-[1.1] animate-fade-in-up [animation-delay:200ms]">
                        Il futuro delle finanze <br />
                        <span className="text-gradient">semplificato e intelligente.</span>
                    </h1>
                    <p className="text-lg md:text-xl text-text-secondary mb-10 leading-relaxed max-w-2xl animate-fade-in-up [animation-delay:400ms]">
                    ...
                    <div className="mt-16 lg:mt-20 pt-10 border-t border-slate-200/90 flex flex-wrap items-center gap-x-12 gap-y-6 animate-fade-in-up [animation-delay:800ms]">
                        <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Partner di Fiducia</p>
                        <div className="flex flex-wrap items-center gap-8 opacity-40 grayscale contrast-125">
                            <span className="text-lg font-bold italic">Goldman Sachs</span>
                            <span className="text-lg font-bold italic">Unicredit</span>
                        </div>
                    </div>
                </div>
