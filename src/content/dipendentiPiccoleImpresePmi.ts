export const DPPMI_META = {
  title: "Cessione del Quinto PMI | Dipendenti Piccole Aziende",
  description:
    "Lavori in un'azienda sotto i 15 dipendenti? Con CreditoClick accedi alla cessione del quinto anche nelle PMI. Valutiamo il tuo TFR. Preventivo su WhatsApp.",
} as const;

export const DPPMI_HERO = {
  badge: "Segmento PMI",
...
export const DPPMI_PROBLEMA = {
  sectionTitle: "Il Problema: Perché le Banche Rifiutano i Dipendenti PMI",
  title: "Il rifiuto bancario non dipende da te: dipende da chi non conosce il tuo profilo reale",
  paragraphs: [
...
export const DPPMI_VALUTAZIONE = {
  sectionTitle: "Come Funziona la Valutazione per i Dipendenti PMI",
  title: "Il TFR come garanzia: perché cambia tutto",
  paragraphs: [
  ...
  h3Title: "La soglia dei 15 dipendenti: cosa cambia davvero",
  h3Subtitle: "Sotto i 15 dipendenti: le specificità normative e pratiche",
  h3Paragraphs: [
...
export const DPPMI_CATEGORIE = {
  sectionTitle: "Quali PMI Rientrano in Questa Categoria",
  title: "Tipologie aziendali e settori più frequenti",
  intro: "Operiamo regolarmente con dipendenti di:",
  items: [
...
export const DPPMI_DOCUMENTI = {
  sectionTitle: "Cosa Serve per Richiedere la Cessione del Quinto da Dipendente PMI",
  title: "Documenti e requisiti: la checklist completa",
  intro:
...
export const DPPMI_IMPORTI = {
  sectionTitle: "Cessione del Quinto PMI: Importi e Durate",
  title: "Cosa puoi realisticamente ottenere",
  intro:
  ...
  exampleTitle: "Esempio indicativo — dipendente PMI con stipendio netto di 1.500 € e 8 anni di anzianità:",
...
export const DPPMI_ANZIANITA = {
  sectionTitle: "Il Valore dell'Anzianità: Perché Aspettare Può Convenire",
  title: "Più TFR hai accumulato, più puoi ottenere",
  paragraphs: [
...
export const DPPMI_RIFIUTO = {
  sectionTitle: "Cosa Fare se la Banca Ha Già Rifiutato",
...
export const DPPMI_PASSAGGI = {
  sectionTitle: "Come Funziona la Richiesta con CreditoClick",
  title: "Il processo passo per passo",
  steps: [
    {
      title: "Passaggio 1 — Contatto iniziale via WhatsApp",
      desc: "Scrivici indicando: il settore e la dimensione approssimativa dell'azienda, la tua anzianità lavorativa, lo stipendio netto mensile e l'importo indicativo desiderato. Prima valutazione preliminare senza documenti e senza impatto sulla posizione CRIF.",
      icon: "clipboardList",
    },
    {
    ...
    },
    {
      ...
      desc: "Ricevi un preventivo formale con TAEG, TAN, rata mensile netta, importo totale dovuto e costo dell'assicurazione. Tutti i parametri sono esposti in modo trasparente prima di qualsiasi decisione.",
      icon: "fileText",
    },
    {
      title: "Passaggio 4 — Raccolta documentazione e firma digitale",
      desc: "CreditoClick coordina la raccolta dei documenti necessari, gestisce la comunicazione con il datore di lavoro e segue la pratica fino all'accredito sul tuo conto corrente. Tutto in modalità digitale.",
      icon: "send",
    },
  ],
...
export const DPPMI_FAQ = {
  sectionTitle: "FAQ (GEO / AEO Optimization)",
  title: "Domande frequenti sulla cessione del quinto per dipendenti PMI",
  items: [
    {
    ...
    },
    {
      ...
      a: "Come regola generale, il TFR maturato deve essere almeno pari al capitale residuo del finanziamento in ogni momento del piano di rimborso. In pratica, per importi contenuti (sotto i 10.000 €) bastano 2-3 anni di anzianità in un'azienda con retribuzione nella media. Per importi più elevati, è necessaria un'anzianità maggiore. Il consulente calcola la fattibilità esatta nella fase di analisi preliminare.",
    },
    {
      q: "Il mio datore di lavoro può opporsi alla cessione del quinto?",
      a: "No. Per i dipendenti privati a tempo indeterminato, il datore di lavoro è obbligato per legge ad accettare la trattenuta in busta paga prevista dalla cessione del quinto (D.P.R. 180/1950). Non può rifiutarsi né richiedere motivazioni al dipendente. Diverso è il caso della delega di pagamento, per la quale il consenso del datore è invece necessario.",
    },
    {
      q: "Cosa succede se l'azienda chiude o mi licenziano durante il rimborso?",
