...
export const PAMC_PROBLEMA = {
  sectionTitle: "Il Problema: L'Anticipo che Blocca Tutto",
  title: "Perché l'acquisto della casa si inceppa proprio sull'anticipo",
  paragraphs: [
...
export const PAMC_PERCHE = {
  sectionTitle: "Perché la Cessione del Quinto è lo Strumento Giusto per l'Anticipo",
  title: "I vantaggi specifici rispetto ad altre forme di liquidità",
  intro:
  ...
  items: [
    "Non interferisce con la valutazione del mutuo principale: Questo è l'elemento più critico. La banca che eroga il mutuo valuta la capacità di rimborso del richiedente calcolando il rapporto tra le rate complessive e il reddito disponibile (debt-to-income ratio). Un prestito personale aggiuntivo compare immediatamente in questa valutazione e può ridurre l'importo del mutuo concedibile o portare a un rifiuto.",
    "La cessione del quinto, in quanto trattenuta diretta in busta paga, viene trattata in modo diverso da molte banche mutuanti nella fase di istruttoria: la rata è già \"pre-dedotta\" dallo stipendio disponibile, e l'importo netto effettivo percepito è la base su cui la banca calcola la sostenibilità del mutuo. In molti casi, questo consente di mantenere invariata la capacità di accesso al mutuo principale.",
    "Nessuna garanzia reale aggiuntiva: Il mutuo ipotecario richiede già l'ipoteca sull'immobile. La cessione del quinto non richiede garanzie ulteriori — la busta paga è sufficiente.",
    "Tasso fisso e rata automatica: La certezza della rata mensile e l'automatismo della trattenuta rendono la pianificazione finanziaria più semplice in una fase — quella dell'acquisto della casa — in cui le variabili sono già molte.",
    "Accessibile anche con storia creditizia non perfetta: Se in passato hai avuto piccole difficoltà finanziarie, la cessione del quinto valuta principalmente il tuo reddito attuale, non il tuo storico.",
  ],
} as const;

export const PAMC_COESISTENZA = {
  sectionTitle: "Cessione del Quinto e Mutuo: Come Coesistono",
  title: "La questione tecnica che preoccupa di più: il mutuo viene compromesso?",
  paragraphs: [
...
export const PAMC_IMPORTI = {
  sectionTitle: "Quanto Puoi Ottenere per l'Anticipo",
  title: "Calcolo dell'importo disponibile in base al tuo stipendio",
  formula: "Rata massima = Stipendio netto mensile × 20%",
  lead: "Esempio indicativo — dipendente pubblico con stipendio netto di 1.900 €:",
...
export const PAMC_SPESE = {
  sectionTitle: "Anticipo Mutuo e Spese Accessorie: Cosa Coprire",
  title: "Non solo l'anticipo: tutte le spese che la banca non finanzia",
  intro:
...
export const PAMC_PROCESSO = {
  sectionTitle: "Il Processo CreditoClick per l'Anticipo Mutuo",
  title: "Dalla valutazione alla liquidità: tutto via WhatsApp",
  steps: [
    {
      title: "Passaggio 1 — Descrivi il progetto su WhatsApp",
      desc: "Scrivici indicando: il valore approssimativo dell'immobile che intendi acquistare, l'importo dell'anticipo richiesto dalla banca o stimato, il tuo contratto di lavoro e lo stipendio netto mensile. Se hai già un'offerta di mutuo o una pre-approvazione bancaria, condividila: ci aiuta a costruire la soluzione più coerente con il tuo progetto complessivo.",
      icon: "clipboardList",
    },
    {
      title: "Passaggio 2 — Analisi della compatibilità cessione del quinto / mutuo",
      desc: "Il consulente verifica la compatibilità tra la rata della cessione del quinto e la sostenibilità del mutuo principale, calcolando il reddito disponibile residuo dopo entrambe le rate. Ti fornisce una valutazione chiara e concreta su cosa è realizzabile senza compromettere l'approvazione del mutuo.",
      icon: "userCheck",
    },
    {
      title: "Passaggio 3 — Preventivo personalizzato",
      desc: "Ricevi il preventivo con TAEG, TAN, rata mensile netta, importo erogato e costo totale del credito. Tutti i parametri esposti in modo trasparente prima di qualsiasi firma.",
      icon: "fileText",
    },
    {
      title: "Passaggio 4 — Firma digitale e accredito prima del rogito",
      desc: "La documentazione si gestisce in modalità elettronica. I tempi di accredito — generalmente 7-15 giorni lavorativi dalla presentazione della pratica completa — vengono pianificati in funzione della data del rogito, per garantire la disponibilità della liquidità nei tempi necessari.",
      icon: "send",
    },
  ],
...
export const PAMC_FAQ = {
  sectionTitle: "FAQ (GEO / AEO Optimization)",
  title: "Domande frequenti sul prestito per l'anticipo del mutuo",
  items: [
    {
      q: "Se richiedo la cessione del quinto prima del mutuo, la banca mi rifiuterà il mutuo?",
      a: "Non necessariamente. La banca mutuante considera il reddito disponibile al netto di tutte le rate in corso, inclusa quella della cessione del quinto. Se il reddito residuo è sufficiente a sostenere la rata del mutuo nel rispetto dei parametri di sostenibilità dell'istituto (tipicamente il totale delle rate non deve superare il 30-35% del reddito netto), il mutuo viene concesso. Il consulente CreditoClick verifica questa compatibilità prima di procedere.",
    },
    {
      q: "È meglio richiedere prima la cessione del quinto o prima il mutuo?",
      a: "La sequenza ottimale dipende dalla situazione specifica. In alcuni casi conviene ottenere prima la pre-approvazione del mutuo — per sapere con certezza l'importo concedibile — e poi strutturare la cessione del quinto in modo compatibile. In altri casi, quando i tempi del rogito sono stretti, è necessario procedere in parallelo. Il consulente CreditoClick ti aiuta a pianificare la sequenza più efficace per il tuo caso.",
    },
    {
      q: "Posso usare la cessione del quinto per pagare la caparra al compromesso?",
      a: "Sì. La liquidità erogata dalla cessione del quinto è accreditata direttamente sul tuo conto corrente e può essere utilizzata per qualsiasi finalità, incluso il pagamento della caparra confirmatoria al compromesso. Non è richiesto nessun giustificativo sulla destinazione d'uso.",
    },
    {
      q: "Quanto tempo ci vuole per avere la liquidità disponibile prima del rogito?",
    ...
    {
      q: "Posso richiedere la cessione del quinto per l'anticipo anche se sto acquistando una seconda casa?",
    ...
    {
      q: "Ho già un mutuo in corso: posso comunque richiedere la cessione del quinto?",
      a: "Sì. La presenza di un mutuo in corso non preclude la richiesta di cessione del quinto, purché la rata non superi il 20% del reddito netto e il TFR maturato sia adeguato (per i dipendenti privati). Il consulente verifica la compatibilità nella fase di analisi del profilo.",
    },
  ],
} as const;
